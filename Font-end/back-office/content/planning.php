...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  if (!empty(trim($_POST["id"]))) {
      ...
      $make_call = callAPI('POST', 'http://localhost:8080/Fitness-Website/Back-end/api/controllers/planning/delete.php', json_encode($idDay));
  } 
}
    ...
    <section class="content container-fluid">
         ...
         <table class="table table-responsive">
           <thead>
            ...
            <tbody>
              <?php
              $get_data = callAPI('GET','http://localhost:8080/Fitness-Website/Back-end/api/controllers/planning/read.php', false);
